...
export const TRANSACTION_ACTION_APPROVE_TOKEN_SIGN_EARN = 'APPROVE_TOKEN_SIGN_EARN';
export const TRANSACTION_ACTION_WAIT_FOR_SIMULATION = 'WAIT_FOR_SIMULATION';
export const TRANSACTION_ACTION_SWAP = 'SWAP';
export const TRANSACTION_ACTION_EARN_DEPOSIT = 'EARN_DEPOSIT';
export const TRANSACTION_ACTION_CREATE_POSITION = 'CREATE_POSITION';
export const TRANSACTION_ACTION_APPROVE_COMPANION_SIGN_EARN = 'APPROVE_COMPANION_SIGN_EARN';
export const TRANSACTION_ACTION_EARN_WITHDRAW = 'EARN_WITHDRAW';
export const TRANSACTION_ACTION_SIGN_TOS_EARN = 'SIGN_TOS_EARN';
...
export const TRANSACTION_ACTION_TYPES: Record<TransactionActionType, TransactionActionType> = {
  ...
  [TRANSACTION_ACTION_APPROVE_TOKEN_SIGN_EARN]: TRANSACTION_ACTION_APPROVE_TOKEN_SIGN_EARN,
  ...
  [TRANSACTION_ACTION_EARN_DEPOSIT]: TRANSACTION_ACTION_EARN_DEPOSIT,
  [TRANSACTION_ACTION_APPROVE_COMPANION_SIGN_EARN]: TRANSACTION_ACTION_APPROVE_COMPANION_SIGN_EARN,
  [TRANSACTION_ACTION_EARN_WITHDRAW]: TRANSACTION_ACTION_EARN_WITHDRAW,
  [TRANSACTION_ACTION_SIGN_TOS_EARN]: TRANSACTION_ACTION_SIGN_TOS_EARN,
};
