...
export default function SilverTrophy({ size }: IconProps) {
  const realSize = size || '28px';
  return (
    <SvgIcon viewBox="5368.36 1087.44 1776.641 1826.733" style={{ fontSize: realSize }}>
      <path
        ...
        style={{ fill: '#b5b7c4', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}
        id="path52"
        transform="matrix(0.133333, 0, 0, -0.133333, 0, 4666.666504)"
      />
      <path
        d="M 48647.6,14101.4 H 45202.7 V 13582 h 3444.9 v 519.4"
        style={{ fill: '#999eae', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}
        id="path60"
        transform="matrix(0.133333, 0, 0, -0.133333, 0, 4666.666504)"
      />
      <path
      ...
      <path
        ...
        style={{ fill: '#a0a2ae', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}
        id="path78"
        transform="matrix(0.133333, 0, 0, -0.133333, 0, 4666.666504)"
      />
      <path
        d="M 49944.6,25506 H 51274 v 482.918 h -1329.4 z"
        style={{ fill: '#888d9d', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}
        id="path80"
        transform="matrix(0.133333, 0, 0, -0.133333, 0, 4666.666504)"
      />
    </SvgIcon>
