export default [
  {
    inputs: [
      ...
      { internalType: 'contract IExternalFirewall', name: 'externalFirewall', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'depositedToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'depositedAmount', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'positionId', type: 'uint256' },
      { indexed: false, internalType: 'address[]', name: 'tokens', type: 'address[]' },
      { indexed: false, internalType: 'uint256[]', name: 'balanceChanges', type: 'uint256[]' },
      { indexed: false, internalType: 'address[]', name: 'actualWithdrawnTokens', type: 'address[]' },
      { indexed: false, internalType: 'uint256[]', name: 'actualWithdrawnAmounts', type: 'uint256[]' },
      { indexed: false, internalType: 'bytes', name: 'result', type: 'bytes' },
      { indexed: false, internalType: 'address', name: 'recipient', type: 'address' },
    ],
    name: 'PositionWithdrawnSpecially',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'YieldDataForToken[]', name: 'yieldData', type: 'uint256[]' },
      {
        components: [
          { internalType: 'uint248', name: 'lossAccum', type: 'uint248' },
          { internalType: 'uint8', name: 'completeLossEvents', type: 'uint8' },
        ],
        internalType: 'struct YieldLossDataForToken[]',
        name: 'yieldLossData',
        type: 'tuple[]',
      },
    ],
