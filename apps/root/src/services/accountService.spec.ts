...
import { Wallet, WalletStatus, WalletType, User, UserStatus } from '@types';
...
describe('Position Service', () => {
  ...
  //     expect(getWalletVerifyingSignatureMock).toHaveBeenCalledWith('0xexternal', tomorrow.toString());
