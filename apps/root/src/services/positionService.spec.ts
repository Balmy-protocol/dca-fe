      ...
      sdkService.getUsersDcaPositions.mockResolvedValue({
        10: [
          createSdkPositionMock({
            ...
            rate: { amount: '20', amountInUnits: '20' },
            remainingSwaps: 0,
            toWithdraw: { amount: '0', amountInUnits: '0' },
            toWithdrawYield: { amount: '0', amountInUnits: '0' },
            swappedYield: { amount: '4', amountInUnits: '4' },
            swapped: { amount: '15', amountInUnits: '15' },
            remainingLiquidity: { amount: '0', amountInUnits: '0' },
            remainingLiquidityYield: { amount: '0', amountInUnits: '0' },
          }),
          createSdkPositionMock({
            id: `10-${HUB_ADDRESS[POSITION_VERSION_4][10]}-2`,
            from: toDcaPositionToken({
    ...
    test('it should set the current positions of the current users', async () => {
      ...
      expect(positionService.pastPositions).toEqual({
        [`10-1-v${PositionVersions.POSITION_VERSION_4}`]: createPositionMock({
          ...
          positionId: 1n,
          status: 'TERMINATED',
          toWithdraw: { amount: 0n, amountInUnits: '0' },
          toWithdrawYield: { amount: 0n, amountInUnits: '0' },
          remainingLiquidity: { amount: 0n, amountInUnits: '0' },
          remainingLiquidityYield: { amount: 0n, amountInUnits: '0' },
          id: `10-1-v${PositionVersions.POSITION_VERSION_4}`,
          rate: { amount: 20n, amountInUnits: '20' },
          remainingSwaps: 0n,
          swapped: { amount: 15n, amountInUnits: '15' },
      ...
      test('it should add the new position to the currentPositions object', () => {
        ...
        expect(positionService.currentPositions).toEqual({
          ...
          [`pending-transaction-hash-v${LATEST_VERSION}`]: {
            ...
            swapped: { amount: 0n, amountInUnits: '0' },
            rate: { amount: parseUnits('10', 18) / 5n, amountInUnits: '2' },
            permissions: [],
            remainingLiquidity: { amount: parseUnits('10', 18), amountInUnits: '10' },
            remainingSwaps: 5n,
            totalSwaps: 5n,
            ...
            toWithdrawYield: { amount: 0n, amountInUnits: '0' },
            remainingLiquidityYield: { amount: 0n, amountInUnits: '0' },
            swappedYield: { amount: 0n, amountInUnits: '0' },
          } satisfies Position,
        });
      });
    });
      ...
      [
        {
          expectedPositionChanges: {
            [`10-4-v${LATEST_VERSION}`]: createPositionMock({
              ...
              positionId: 4n,
              remainingLiquidity: { amount: parseUnits('20', 18), amountInUnits: '20' },
              remainingSwaps: 10n,
              swapped: { amount: 0n, amountInUnits: '0' },
              toWithdraw: { amount: 0n, amountInUnits: '0' },
              totalExecutedSwaps: 0n,
        ...
        },
        {
          expectedPositionChanges: {
            [`modify-rate-and-swaps-increase-position-v${LATEST_VERSION}`]: createPositionMock({
              ...
              rate: { amount: parseUnits('20', 18), amountInUnits: '20' },
              totalSwaps: 25n,
              remainingSwaps: 15n,
              remainingLiquidity: { amount: parseUnits('300', 18), amountInUnits: '300' },
            }),
          },
          basePositions: {
            [`modify-rate-and-swaps-increase-position-v${LATEST_VERSION}`]: createPositionMock({
        ...
        },
        {
          expectedPositionChanges: {
            [`modify-rate-and-swaps-reduce-position-v${LATEST_VERSION}`]: createPositionMock({
              ...
              rate: { amount: parseUnits('4', 18), amountInUnits: '4' },
              totalSwaps: 15n,
              remainingSwaps: 5n,
              remainingLiquidity: { amount: parseUnits('20', 18), amountInUnits: '20' },
            }),
        ...
        },
        {
          expectedPositionChanges: {
            [`withdraw-funds-position-v${LATEST_VERSION}`]: createPositionMock({
              ...
              rate: { amount: 0n, amountInUnits: '0' },
              totalSwaps: 10n,
              remainingLiquidity: { amount: 0n, amountInUnits: '0' },
              remainingSwaps: 0n,
            }),
