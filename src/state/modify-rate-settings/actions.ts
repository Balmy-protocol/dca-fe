...
export const initializeModifyRateSettings = createAction<{ fromValue: string; frequencyValue: string, rate: string, modeType: typeof FULL_DEPOSIT_TYPE | typeof RATE_TYPE; }>(
