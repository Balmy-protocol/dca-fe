      ...
      switch (transaction.type) {
        case TRANSACTION_TYPES.TERMINATE_POSITION: {
          history.push({
            ...
            oldDepositedRateUnderlying: position.depositedRateUnderlying || position.rate,
            withdrawnUnderlying: position.accumSwappedUnderlying || position.withdrawn,
            swappedUnderlying: '0',
        ...
        case TRANSACTION_TYPES.WITHDRAW_POSITION: {
          history.push({
            ...
            depositedRateUnderlying: position.depositedRateUnderlying || position.rate,
            oldDepositedRateUnderlying: position.depositedRateUnderlying || position.rate,
            withdrawnUnderlying: position.accumSwappedUnderlying || position.toWithdraw,
            swappedUnderlying: '0',
            permissions: [],
            ratioPerUnitBToAWithFee: '1',
            rateUnderlying: position.rate,
