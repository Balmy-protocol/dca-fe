      ...
      switch (tx.type) {
        ...
        case TRANSACTION_TYPES.TERMINATE_POSITION: {
          ...
          if (terminatedPosition) {
            message = `Burning your ${(terminatedPosition as Position).from.symbol}:${
        ...
        case TRANSACTION_TYPES.APPROVE_TOKEN_EXACT: {
          ...
          message = `Approving ${tokenApprovalExactTypeData.amount} ${tokenApprovalExactTypeData.token.symbol}`;
          break;
        }
        default:
          break;
