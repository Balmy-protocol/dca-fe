...
import { NETWORKS, POSITION_VERSION_4, STRING_SWAP_INTERVALS } from '@constants';
      ...
      >
        ...
        <StyledDetailWrapper>
          <Typography variant="body1" color="rgba(255, 255, 255, 0.5)">
            <FormattedMessage description="jbrlUserCompInvestingIn" defaultMessage="Investing in:" />
          </Typography>
      ...
      <Collapse in={showDetails}>
        <StyledCardContent>
          <StyledMainData $spaceBetween>
            ...
            <StyledDetailWrapper>
              <Typography variant="body1" color="rgba(255, 255, 255, 0.5)">
                <FormattedMessage description="jbrlUserCompPositions" defaultMessage="Positions:" />
              </Typography>
              <Typography variant="body1" sx={{ marginLeft: '5px' }}>
          ...
          <StyledDetailWrapper>
            <Typography variant="body1" color="rgba(255, 255, 255, 0.5)">
              <FormattedMessage description="jbrlUserCompEarnedInToken" defaultMessage="Earned by token:" />
            </Typography>
          </StyledDetailWrapper>
          <StyledMainData>
          ...
          <StyledDetailWrapper onClick={() => setShowPositions(!showPositions)} $spaceItems>
            <Typography variant="body1">
              <FormattedMessage description="jbrlUserCompViewPositions" defaultMessage="View positons" />
            </Typography>
